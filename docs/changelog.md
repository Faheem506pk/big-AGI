...
- milestone: [1.17.0](https://github.com/alphabaseOfficial/Zaplead)
...
- YouTube Transcriber Persona for chatting with video content, [#500](https://github.com/alphabaseOfficial/Zaplead/pull/500)
- Improved formula rendering (LaTeX), and dark-mode diagrams, [#508](https://github.com/alphabaseOfficial/Zaplead/issues/508), [#520](https://github.com/alphabaseOfficial/Zaplead/issues/520)
- Models update: **Anthropic**, **Groq**, **Ollama**, **OpenAI**, **OpenRouter**, **Perplexity**
- Code soft-wrap, chat text selection toolbar, 3x faster on Apple silicon, and more [#517](https://github.com/alphabaseOfficial/Zaplead/issues/517), [507](https://github.com/alphabaseOfficial/Zaplead/pull/507)
...
- ⚠️ [**Beam**: the multi-model AI chat](https://alphabase.co/blog/beam-multi-model-ai-reasoning). find better answers, faster - a game-changer for brainstorming, decision-making, and creativity. [#443](https://github.com/alphabaseOfficial/Zaplead/issues/443)
- Managed Deployments **Auto-Configuration**: simplify the UI mdoels setup with backend-set models. [#436](https://github.com/alphabaseOfficial/Zaplead/issues/436)
- Message **Starring ⭐**: star important messages within chats, to attach them later. [#476](https://github.com/alphabaseOfficial/Zaplead/issues/476)
- Enhanced the default Persona
- Fixes to Gemini models and SVGs, improvements to UI and icons
- Beast release, over 430 commits, 10,000+ lines changed: [release notes](https://github.com/alphabaseOfficial/Zaplead/releases/tag/v1.15.0), and changes [v1.14.1...v1.15.0](https://github.com/alphabaseOfficial/Zaplead/compare/v1.14.1...v1.15.0)

### What's New in 1.14.1 · March 7, 2024 · Modelmorphic

- **Anthropic** [Claude-3](https://www.anthropic.com/news/claude-3-family) model family support. [#443](https://github.com/alphabaseOfficial/Zaplead/issues/443)
- New **[Perplexity](https://www.perplexity.ai/)** and **[Groq](https://groq.com/)** integration (thanks @Penagwin). [#407](https://github.com/alphabaseOfficial/Zaplead/issues/407), [#427](https://github.com/alphabaseOfficial/Zaplead/issues/427)
- **[LocalAI](https://localai.io/models/)** deep integration, including support for [model galleries](https://github.com/alphabaseOfficial/Zaplead/issues/411)
...
- [Release notes](https://github.com/alphabaseOfficial/Zaplead/releases/tag/v1.14.0), and changes [v1.13.1...v1.14.0](https://github.com/alphabaseOfficial/Zaplead/compare/v1.13.1...v1.14.0) (233 commits, 8,000+ lines changed)

### What's New in 1.13.0 · Feb 8, 2024 · Multi + Mind

https://github.com/alphabaseOfficial/Zaplead/assets/32999/01732528-730e-41dc-adc7-511385686b13

- **Side-by-Side Split Windows**: multitask with parallel conversations. [#208](https://github.com/alphabaseOfficial/Zaplead/issues/208)
- **Multi-Chat Mode**: message everyone, all at once. [#388](https://github.com/alphabaseOfficial/Zaplead/issues/388)
- **Export tables as CSV**: big thanks to @aj47. [#392](https://github.com/alphabaseOfficial/Zaplead/pull/392)
- Adjustable text size: customize density. [#399](https://github.com/alphabaseOfficial/Zaplead/issues/399)
- Dev2 Persona Technology Preview
- Better looking chats with improved spacing, fonts, and menus
- More: new video player, [LM Studio tutorial](https://github.com/alphabaseOfficial/Zaplead/blob/main/docs/config-local-lmstudio.md) (thanks @aj47), [MongoDB support](https://github.com/alphabaseOfficial/Zaplead/blob/main/docs/deploy-database.md) (thanks @ranfysvalle02), and speedups

### What's New in 1.12.0 · Jan 26, 2024 · AGI Hotline

https://github.com/alphabaseOfficial/Zaplead/assets/32999/95ceb03c-945d-4fdd-9a9f-3317beb54f3f

- **Voice Calls**: real-time voice call your personas out of the blue or in relation to a chat [#354](https://github.com/alphabaseOfficial/Zaplead/issues/354)
- Support **OpenAI 0125** Models. [#364](https://github.com/alphabaseOfficial/Zaplead/issues/364)
- Rename or Auto-Rename chats.  [#222](https://github.com/alphabaseOfficial/Zaplead/issues/222), [#360](https://github.com/alphabaseOfficial/Zaplead/issues/360)
- More control over **Link Sharing** [#356](https://github.com/alphabaseOfficial/Zaplead/issues/356)
- **Accessibility** to screen readers [#358](https://github.com/alphabaseOfficial/Zaplead/issues/358)
- Export chats to Markdown [#337](https://github.com/alphabaseOfficial/Zaplead/issues/337)
- Paste tables from Excel [#286](https://github.com/alphabaseOfficial/Zaplead/issues/286)
- Ollama model updates and context window detection fixes [#309](https://github.com/alphabaseOfficial/Zaplead/issues/309)

### What's New in 1.11.0 · Jan 16, 2024 · Singularity

https://github.com/alphabaseOfficial/Zaplead/assets/1590910/a6b8e172-0726-4b03-a5e5-10cfcb110c68

- **Find chats**: search in titles and content, with frequency ranking. [#329](https://github.com/alphabaseOfficial/Zaplead/issues/329)
- **Commands**: command auto-completion (type '/'). [#327](https://github.com/alphabaseOfficial/Zaplead/issues/327)
- **[Together AI](https://www.together.ai/products#inference)** inference platform support (good speed and newer models). [#346](https://github.com/alphabaseOfficial/Zaplead/issues/346)
...
- **New UI**: for both desktop and mobile, sets the stage for future scale. [#201](https://github.com/alphabaseOfficial/Zaplead/issues/201)
- **Conversation Folders**: enhanced conversation organization. [#321](https://github.com/alphabaseOfficial/Zaplead/issues/321)
...
- **DALL·E 3 integration** for enhanced image generation. [#212](https://github.com/alphabaseOfficial/Zaplead/issues/212)
- **Perfect scrolling mechanics** across devices. [#304](https://github.com/alphabaseOfficial/Zaplead/issues/304)
- Persona creation now supports **text input**. [#287](https://github.com/alphabaseOfficial/Zaplead/pull/287)
...
- **Google Gemini Support**: Use the newest Google models. [#275](https://github.com/enricoros/Zaplead/issues/275)
- **Mistral Platform**: Mixtral and future models support. [#273](https://github.com/enricoros/Zaplead/issues/273)
- **Diagram Instructions**. Thanks to @joriskalz! [#280](https://github.com/enricoros/Zaplead/pull/280)
- Ollama Chats: Enhanced chatting experience. [#270](https://github.com/enricoros/Zaplead/issues/270)
- Mac Shortcuts Fix: Improved UX on Mac
- **Single-Tab Mode**: Data integrity with single window. [#268](https://github.com/enricoros/Zaplead/issues/268)
- **Updated Models**: Latest Ollama (v0.1.17) and OpenRouter models
- Official Downloads: Easy access to the latest Zaplead on [Zaplead.com](https://alphabase.co)
- For developers: [troubleshot networking](https://github.com/alphabaseOfficial/Zaplead/issues/276#issuecomment-1858591483), fixed Vercel deployment, cleaned up the LLMs/Streaming framework

### What's New in 1.7.0 · Dec 11, 2023 · Attachment Theory

- **Attachments System Overhaul**: Drag, paste, link, snap, text, images, PDFs and more. [#251](https://github.com/enricoros/Zaplead/issues/251)
- **Desktop Webcam Capture**: Image capture now available as Labs feature. [#253](https://github.com/enricoros/Zaplead/issues/253)
- **Independent Browsing**: Full browsing support with Browserless. [Learn More](https://github.com/enricoros/Zaplead/blob/main/docs/config-feature-browse.md)
- **Overheat LLMs**: Push the creativity with higher LLM temperatures. [#256](https://github.com/enricoros/Zaplead/issues/256)
- **Model Options Shortcut**: Quick adjust with `Ctrl+Shift+O`
- Optimized Voice Input and Performance
- Latest Ollama models
- For developers: **Password Protection**: HTTP Basic Auth. [Learn How](https://github.com/enricoros/Zaplead/blob/main/docs/deploy-authentication.md)

### What's New in 1.6.0 - Nov 28, 2023 · Surf's Up

- **Web Browsing**: Download web pages within chats - [browsing guide](https://github.com/enricoros/Zaplead/blob/main/docs/config-feature-browse.md)
...
- Runtime Server-Side configuration:  https://github.com/enricoros/Zaplead/issues/189. Env vars are
  ...
  https://github.com/enricoros/Zaplead/blob/main/src/modules/backend/backend.router.ts.
...
- Removed the 20 chats hard limit ([Ashesh3](https://github.com/enricoros/Zaplead/pull/158))
- Latex Rendering
...
- **Code Execution: Sandpack** -
  [now on branch]((https://github.com/enricoros/Zaplead/commit/f678a0d463d5e9cf0733f577e11bd612b7902d89)) `variant-code-execution`
