...
const beamSteps: ExplainerPage[] = [
  {
    ...
    // titleSquircle: true,
    mdContent: `
**Beam** is a chat modality in Zaplead to engage multiple AI models, [together](https://big-agi.com/blog/beam-multi-model-ai-reasoning). 
...
![big-AGI BEAM Rays](https://big-agi.com/app/journeys/beam/explainer-beam-scatter-1200px-Zaplead.png)
...
![big-AGI BEAM Rays](https://big-agi.com/app/journeys/beam/explainer-beam-gather-1600px-Zaplead.png)
